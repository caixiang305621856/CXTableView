...
- (void)layoutSubviews {
    ...
    if(hasCustomView) {
        ...
        CGSize titleSize = [self sizeForLabelWithString:self.titleLabel.text font:self.titleLabel.font constrainedToSize:CGSizeMake(labelMaxWidth, self.titleLabel.font.lineHeight)];
        
        CGSize subtitleSize = [self sizeForLabelWithString:self.subtitleLabel.text font:self.subtitleLabel.font constrainedToSize:CGSizeMake(labelMaxWidth, self.subtitleLabel.font.lineHeight)];
